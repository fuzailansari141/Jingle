...
 var h = d.getHours(); 
 ...
 var pay=["WHAT TYPE OF PAYMENT PROCESS ARE ACCEPTED?","WHAT TYPE OF PAYMENT PROCESS ARE ACCEPTED","PAYMENT PROCESSESS","PAYMENT PROCESS"]
 var mum=["WHAT ARE THE VENUES IN MUMBAI?","WHAT ARE THE VENUES IN MUMBAI","VENUES IN MUMBAI","MUMBAI VENUES"]
 ...
 var yes=["WHAT IS JINGLE?","JINGLE","WHY JINGLE?","WHY JINGLE","WHAT IS THE MEANING OF JINGLE?"]
 var states=["WHICH STATES ARE YOU COVERING?","WHICH STATES ARE YOU COVERING","STATES","WHICH STATES ARE AVAILABLE HERE?","WHICH STATES ARE AVAILABLE HERE"];
 var spec=["WHAT IS SPECIAL IN YOUR WEBSITE","IS THERE ANYTHING SPECIAL IN YOUR WEBSITE?","IS THERE ANYTHING SPECIAL IN YOUR WEBSITE","SPECIAL","DIFFERENCE","DIFFERENCE BETWEEN YOUR AND OTHER WEBSITES"]
 var book=["HOW MANY MEMBERS CAN WE BOOK AT ONE TIME?","HOW MANY MEMBERS CAN WE BOOK AT ONE TIME","NUMBER OF MEMBERS AT ONE TIME","NUMBER OF MEMBERS"]
 ...
 var wrud=["WHAT R U DOING?","WHAT ARE YOU DOING?", "WHAT'S UP", "WHAT'S UP BUDDY","WHAT ARE YOU DOING"];
  ...
  var link=["HOW CAN I BOOK THE VENUES?","HOW CAN I BOOK THE VENUES","HOW TO BOOK THE VENUES?","HOW TO BOOK THE VENUES","BOOK THE VENUES"]
...
isInArray(yes, lastmsg)==true?(smsg="With Jingle, you can book amazing events for Christmas and New Year parties and take advantage of exciting offers", k=smsg):
isInArray(wru, lastmsg)==true?(smsg="I am Andy Lad", k=smsg):
isInArray(link, lastmsg)==true?(k="These are some steps to book a ticket",smsg=k+"<p>1.Click View all in home page</p><p>2.Enter the email and click Book Now</p><p>3.Spin the Wheel to claim the offer</p><p>4.Fill the necessary details and book the ticket. "):
...
isInArray(pay, lastmsg)==true?(smsg="We accept cards like VISA,MasterCard,American Express and Discover",k=smsg):
isInArray(gn, lastmsg)==true?(smsg="Good night", k=smsg):
isInArray(mum,lastmsg)==true?(smsg="There are some famous venues in Mumbai like The Lalit Mumbai Grand New Year Festival,High2Happiness New Year Brunch Blast,Sensational New Year Eve Bash",k=smsg):
isInArray(welcome, lastmsg)==true?(smsg="Thanks", k=smsg):
isInArray(s2u, lastmsg)==true?(smsg="Aww... I miss  you too..😢 ", k=smsg):
isInArray(states, lastmsg)==true?(k="There are over 13 states availaible. Here they are:-", smsg=k+"<p>1.Maharashtra<p>2.Hyderabad<p>3.Karnataka(Banglore)<p>4.Goa<p>5.Tamil Nadu<p>6.West Bengal<p>7.Uttar Pradesh<p>8.Rajasthan<p>9.Assam<p>10.Punjab<p>11.Haryana<p>12.Gujrat<p>13.Delhi"):
isInArray(spec, lastmsg)==true?(k="To know what is special in our website you must explore now", smsg=k+"😎"):
isInArray(book, lastmsg)==true?(k="You can book atmost 3 members at one time.", smsg=k+"😍"):
